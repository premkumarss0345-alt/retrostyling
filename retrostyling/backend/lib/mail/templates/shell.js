...
export function statusBadge(status) {
  const map = {
    ...
    pending:          { label: 'Return Requested',   color: '#B45309', bg: '#FFFBEB', border: '#FDE68A' },
    return_approved:  { label: 'Return Approved',    color: '#15803D', bg: '#F0FDF4', border: '#BBF7D0' },
    approved:         { label: 'Return Approved',    color: '#15803D', bg: '#F0FDF4', border: '#BBF7D0' },
    return_rejected:  { label: 'Return Rejected',    color: '#DC2626', bg: '#FEF2F2', border: '#FECACA' },
    rejected:         { label: 'Return Rejected',    color: '#DC2626', bg: '#FEF2F2', border: '#FECACA' },
    pickup_scheduled: { label: 'Pickup Scheduled 🚚',color: '#1D4ED8', bg: '#EFF6FF', border: '#BFDBFE' },
    return_picked_up: { label: 'Item Picked Up 📦',  color: '#7C3AED', bg: '#F5F3FF', border: '#DDD6FE' },
    return_received:  { label: 'Item Received 🏬',   color: '#6D28D9', bg: '#F5F3FF', border: '#DDD6FE' },
    received:         { label: 'Item Received 🏬',   color: '#6D28D9', bg: '#F5F3FF', border: '#DDD6FE' },
    refund_initiated: { label: 'Refund Initiated 💳', color: '#B45309', bg: '#FFFBEB', border: '#FDE68A' },
